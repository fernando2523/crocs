...
export default function Expense() {
    ...
    async function loaddataasset(warehouse: any, query: any, loadmorelimit: any, Urutan: any, Brand: any) {
        ...
        await axios({
            method: "post",
            url: `https://api.gudangsandal.com/v1/get_asset`,
            data: {
                id_ware: warehouse,
                query: query,
    ...
    async function show_po(produk: any, idproduk: any, id_ware: any) {
        ...
        await axios
            .post(`https://api.gudangsandal.com/v1/gethistoripoasset`, {
                idware: id_ware,
                idproduct: idproduk,
            })
            .then(function (response) {
                    ...
                    <>
                        <select
                            ...
                            onChange={(e) => {
                                ...
                                loaddataasset(Warehouse, Query, loadmorelimit, Urutan, e.target.value);
                                // getwarehouse(Role, area, e.target.value)
                            }}
                            className={`appearance-none border h-[45px] w-[15%] px-5  text-gray-700 focus:outline-none rounded-lg`}
                        >
                            {"SUPER-ADMIN" === Cookies.get("auth_role") ? (
                                <>

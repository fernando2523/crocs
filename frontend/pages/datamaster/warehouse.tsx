...
export default function Warehouse() {
  ...
  async function loaddatawarehouse() {
    ...
    await axios({
      ...
      .then(function (response) {
        ...
        response.data.data_warehouse.forEach((brands: any) => {
          if (!loggedBrands.has(brands.brand)) {
            loggedBrands.add(brands.brand);
            hasil_brand.push({
              id_brand: brands.brand,
              brand: brands.brand,
            });
          }
        });
        setdatabrand(hasil_brand);
  ...
  const onSubmit = async (data: any) => {
    await axios
      .post("https://api.gudangsandal.com/v1/addwarehouse", data)
      .then(function (response) {
        loaddatawarehouse();
      });
  ...
  const onSubmitUpdate = async (data: any) => {
    ...
    await axios
      .post(`https://api.gudangsandal.com/v1/editwarehouse`, { data, id })
      .then(function (response) {
  ...
  async function deleteData() {
    await axios
      .post(`https://api.gudangsandal.com/v1/deletewarehouse`, { id })
      .then(function (response) {
        console.log(response.data);
        loaddatawarehouse();
      });
